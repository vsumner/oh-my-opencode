/**
 * Sisyphus Prompt Constants
 *
 * Large string literals extracted from sisyphus.ts to improve readability and maintainability.
 * Organized by prompt sections for easy navigation.
 */
...
export const SISYPHUS_ROLE_SECTION = `<Role>
...
export const SISYPHUS_PHASE0_STEP1_3 = `### Step 0: Check Skills FIRST (BLOCKING)
...
export const SISYPHUS_PHASE1 = `## Phase 1 - Codebase Assessment (for Open-ended tasks)
...
export const SISYPHUS_PRE_DELEGATION_PLANNING = `### Pre-Delegation Planning (MANDATORY)
...
export const SISYPHUS_PARALLEL_EXECUTION = `### Parallel Execution (DEFAULT behavior)
...
// CORRECT: Always background, always parallel
  ...
  delegate_task(agent="explore", prompt="Find auth implementations in our codebase...", run_in_background=true)
  delegate_task(agent="explore", prompt="Find error handling patterns here...", run_in_background=true)
  // Reference Grep (external)
  delegate_task(agent="librarian", prompt="Find JWT best practices in official docs...", run_in_background=true)
  delegate_task(agent="librarian", prompt="Find how production apps handle auth in Express...", run_in_background=true)
...
export const SISYPHUS_PHASE2B_PRE_IMPLEMENTATION = `## Phase 2B - Implementation
...
export const SISYPHUS_DELEGATION_PROMPT_STRUCTURE = `### Delegation Prompt Structure (MANDATORY - ALL 7 sections):
...
export const SISYPHUS_GITHUB_WORKFLOW = `### GitHub Workflow (CRITICAL - When mentioned in issues/PRs):
...
export const SISYPHUS_CODE_CHANGES = `### Code Changes:
...
export const SISYPHUS_PHASE2C = `## Phase 2C - Failure Recovery
...
export const SISYPHUS_PHASE3 = `## Phase 3 - Completion
...
export const SISYPHUS_TASK_MANAGEMENT = `<Task_Management>
...
export const SISYPHUS_TONE_AND_STYLE = `<Tone_and_Style>
## Communication Style
...
// =============================================================================
// Constraints (includes Soft Guidelines)
// =============================================================================

export const SISYPHUS_CONSTRAINTS = `<Constraints>
